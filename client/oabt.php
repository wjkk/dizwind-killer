...
class Oabt 
{
    ...
    public $server = "http://www.bubamao.com";
    ...
    function getHtml() {
        ...
        /*
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "http://www.wuzeren.com");
    ...
    function getTask() {
        ...
        $task = array(
            'site' => 'diypda',
            'site_id' => '101',
            'href' => array("http://oabt.org/index.php?page=%d", 1, 1, 1),   
            'path' => "tbody[onmouseover]",
            'list' => array(
                'cat_url' => "j('a[class=sbule]', 'href')",
                'cat_title' => "j('a[class=sbule]', 'innertext')",
                'title' => "j('a[target=_blank]', 'innertext')",
                'href' => "j('a[target=_blank]', 'href')",
                'mag' => "j('a[class=magDown]', 'href')",
		'ed2k' => "a('a[class=ed2kDown]', 'ed2k')",
		'time' => "j('td[class=capacity]', 'innertext')",
		'size' => "j('td[class=seed]', 'innertext')",
            ),
            'endkey' => 'reply_time'
        );
